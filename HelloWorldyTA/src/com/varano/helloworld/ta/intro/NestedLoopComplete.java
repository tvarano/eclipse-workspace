...
public class NestedLoopComplete extends JPanel implements MouseListener, KeyListener
{
...
/*16*/   for(int c=4-r; c<5; c++) //MUST USE c HERE...just change values/conditions
   ...
   private static void createAndShowGUI() {
      ...
      frame.getContentPane().add(new NestedLoopComplete());
      frame.pack();
