...
public class FunNumber {
	...
	/**
	 * @return an integer with digits that are the reverse of the Fun Number
	 *         digits
	 */
	...
	public static void main(String[] args) {
		FunNumber i = new FunNumber(723452345);
		for (int j = 0; j < i.numDigits(); j++)
			System.out.print(i.getDigits()[j]);
