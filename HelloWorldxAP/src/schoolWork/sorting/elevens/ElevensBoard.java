...
public class ElevensBoard {
	...
	private boolean containsJQK(List<Integer> selectedCards) {
	   ...
	   for (int i = 0; i < selectedCards.size(); i++) { 
	      if (cardAt(selectedCards.get(i)).rank().equals(RANKS[10]))
	         jack = true;
	      if (cardAt(selectedCards.get(i)).rank().equals(RANKS[11]))
	         queen = true;
	      if (cardAt(selectedCards.get(i)).rank().equals(RANKS[12]))
	         king = true;
	   }
