...
public class OldJukebox {
   ...
   public static void load(String s, String n) {
      ...
      Clip clip;
      try {
         InputStream in = OldJukebox.class.getResourceAsStream(s);
...
//       System.out.println(ais);
   ...
   public static void main(String[] args)
   {
      OldJukebox.init();
   // load music
      OldJukebox.load("splash.wav", "music");
      OldJukebox.setVolume("music", 5);    
      OldJukebox.play("music");
      try
      {
         Thread.sleep(1000);
